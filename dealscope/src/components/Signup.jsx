    ...
    return(
        <div className="flex flex-col bg-slate-50 h-screen justify-center items-center gap-2">
            <div className="flex flex-col text-center px-5 py-8 bg-gray-100 border border-slate-300 min-w-96 max-w-fit max-h-fit rounded-lg">
                ...
                <div>
                    <form onSubmit={handleSubmit} className="flex flex-col m-2 text-left gap-3">
                        <input type="text" name="username" placeholder="Username" onChange={handleChange} className="transition duration-200 rounded p-1 border border-gray-300" required />
                        <input type="email" name="email" placeholder="Email" onChange={handleChange} className="transition duration-200 rounded p-1 border border-gray-300" required />
                        <input type="password" name="password" placeholder="Password" onChange={handleChange} className="transition duration-200 rounded p-1 border border-gray-300" required />
