...
export default function Card(props) {
    return(
        <a href={props.url} target="_blank" rel="noopener noreferrer" className="flex-col gap-2 text-black flex border-slate-300 translate hover:scale-105 border rounded-xl w-[300px] h-[500px] m-4 p-3"> 
            <img src={props.img} alt="" className="w-fit"/>
