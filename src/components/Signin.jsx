...
export default function Signin(){
    return(
        <div className="flex flex-col bg-slate-50 h-screen justify-center items-center gap-2">
            <div className="flex flex-col text-center px-5 py-8 bg-slate-300 min-w-96 max-w-fit max-h-fit rounded-lg">
            ...
            <div className="flex flex-row justify-center px-5 py-8 bg-slate-300 min-w-96 max-w-fit max-h-fit rounded-lg">
