    ...
    return(
        <div className="border-b flex justify-center border-slate-400">
            <div className="flex container h-14 font-mono font-semibold items-center justify-between px-6">
                <div className="text-2xl font-roboto cursor-pointer hover:scale-105 hover:bg-stone-900 hover:text-gray-50 px-3 py-1 rounded transition duration-200 ease-in-out">
                    DealScope
                </div>
                ...
                <div className="gap-4 flex">
                    <button className="border hover:scale-105 transition duration-200 px-3 py-1 rounded-md border-slate-400">Sign in</button>
